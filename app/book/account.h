...
public:
    virtual Currency::Type currencyType() const override { return currency_type_; }
    virtual QString getFinancialStatementName() const override { return "Balance Sheet"; };
...
public:
    virtual QString getFinancialStatementName() const override { return "Income Statement"; };
...
public:
    ...
    virtual Type accountType() const override { return Asset; }
    virtual bool isInvestment() const override { return is_investment_; }
    virtual void setIsInvestment(bool is_investment) override { is_investment_ = is_investment; }
...
public:
    ...
    virtual Type accountType() const override { return Liability; }
...
public:
    ...
    virtual Type accountType() const override { return Equity; }
...
public:
    ...
    virtual Type accountType() const override { return Expense; }
...
public:
    ...
    virtual Type accountType() const override { return Revenue; }
