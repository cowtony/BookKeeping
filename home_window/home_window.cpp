...
HomeWindow::HomeWindow(QWidget *parent)
    ...
    JsonDelegate *jsonDelegate = new JsonDelegate(ui->tableView);
    for (int col = 2; col <= 5; ++col) {
        ui->tableView->setItemDelegateForColumn(col, jsonDelegate);
    }
...
void HomeWindow::onPushButtonMergeClicked() {
    ...
    case QMessageBox::Ok: {
        ...
        book.insertTransaction(merged_transaction);
        refreshTable();
        break;
    }
